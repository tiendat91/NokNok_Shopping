...
{
    public partial class NokNok_ShoppingContext : DbContext
    {
        public NokNok_ShoppingContext()
        {
        }

        public NokNok_ShoppingContext(DbContextOptions<NokNok_ShoppingContext> options)
            : base(options)
        {
        }
